...
$(document).ready(function () {
    // Find all <a> tags with class 'nav-link' inside <li> with class 'dropdown-item'
    $('.dropdown-menu li a').removeClass('nav-link').addClass('dropdown-item');
    $('.dropdown-menu li').removeClass('dropdown-item');
});
...
jQuery(document).ready(function ($) {
    AOS.init();
    // Your other custom JS code here
});
